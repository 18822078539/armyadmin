package com.army.armyadmin.job.service.impl;

import com.army.armyadmin.common.annotation.CronTag;
import com.army.armyadmin.common.service.impl.BaseService;
import com.army.armyadmin.job.dao.JobMapper;
import com.army.armyadmin.job.domain.Job;
import com.army.armyadmin.job.service.JobService;
import com.army.armyadmin.job.util.ScheduleUtils;
...
public class JobServiceImpl extends BaseService<Job> implements JobService {
    ...
    public List<Job> getSysCronClazz(Job job) {
        Reflections reflections = new Reflections("com.army.armyadmin.job.task");
