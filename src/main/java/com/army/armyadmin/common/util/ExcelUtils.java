...
import com.army.armyadmin.common.annotation.ExportConfig;
import com.army.armyadmin.common.handler.ExportHandler;
import com.army.armyadmin.common.util.poi.convert.ExportConvert;
import com.army.armyadmin.common.util.poi.pojo.ExportItem;
...
public class ExcelUtils {
    ...
    private void requiredbuilderParams() {
        if (mClass == null) {
            throw new IllegalArgumentException("请先使用com.army.armyadmin.util.ExcelUtils.builder(Class<?>)构造器初始化参数。");
        }
    }
    ...
    private void requiredexportParams() {
        if (mClass == null || mResponse == null) {
            throw new IllegalArgumentException(
                    "请先使用com.army.armyadmin.util.ExcelUtils.export(Class<?>, HttpServletResponse)构造器初始化参数。");
        }
